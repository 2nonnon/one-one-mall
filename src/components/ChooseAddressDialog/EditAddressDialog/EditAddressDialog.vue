<template>
    <div class="address-wrapper">
        <div class="address-header">
            <div class="address-title">{{ isEdit ? '编辑收货地址' : '新增收货地址' }}</div>
            <img src="/Address/close.png" alt="关闭" class="address-close-icon" @click="handleClose" />
        </div>
        <div class="address-form">
            ...
            <div class="address-field">
                ...
                <div class="address-value radio" @click="hanldeToggleDefault">
                    <div class="address-radio" :class="{ 'active': address.isDefault }"></div>
        ...
        <div class="address-button-wrapper">
            <div class="address-button line" v-if="isEdit">
                <div class="address-button-text" @click="handleDeleteAddress">删除地址</div>
            </div>
            <div class="address-button" :class="{ 'disabled': !isValidate }">
                <div class="address-button-text" @click="handleSaveAddress">保存地址</div>
            </div>
        </div>
    </div>
</template>
...
import { computed, defineEmits, defineProps, onMounted, reactive, watchEffect } from 'vue';
