<template>
    <div class="address-dialog">
                ...
                >
                    <div class="address-list-item-content">
                        <div class="address-list-item-info">
                            ...
                            >{{ `${item.mobile.slice(0, 3)}****${item.mobile.slice(7)}` }}</span>
                            <div class="address-list-item-default" v-if="item.isDefault">默认</div>
                        </div>
                        <div
                            class="address-list-item-location address-list-item-ellipsis"
        ...
        <EditAddressDialogVue v-else @close-edit="handleCloseEdit" :id="editId" :status="_status"></EditAddressDialogVue>
    </div>
</template>
