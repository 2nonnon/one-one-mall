        ...
        <div class="navbar_container">
            <div class="info">
                <div class="brand" @click="handleToHome">
                    <img src="/Header/2cac505fff45659450cb223041e7eb5c_1539795377150607708.png" alt="米游铺" />
                </div>
                <div class="divider"></div>
                <div class="shop_icon" @click="handleToHome">
                    <img src="/Header/6fc386b329c4b3726cc011c7a0ac85f5_3901303110715729633.png" alt="原神" />
                </div>
            ...
            <div class="func">
                <div class="search">
                    ...
                    <div class="search_icon" @click="handleSearch">
                        <svg t="1649934445180" class="search-icon x-icon" viewBox="0 0 1024 1024" version="1.1"
                ...
                <div class="user" :class="{ logined: isLogined }">
                    ...
                    <div class="menu">
                        <div class="menu_item" @click="handleToUser">
                            <div class="icon">
                                <svg t="1649938571145" class="x-icon" viewBox="0 0 1024 1024" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" p-id="140495">
                                    <path
                        ...
                        <div class="menu_item" @click="handleQuit">
                            <div class="icon">
                                <svg t="1649938646716" class="quit-icon x-icon" viewBox="0 0 1024 1024" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" p-id="141095">
                                    <path
                ...
                <div class="cart" @click="handleValidate(handleToCart)">
                    <div class="cart_icon">
                        <svg t="1649937067005" class="cart-icon x-icon" viewBox="0 0 1024 1024" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" p-id="85483">
                            <path
