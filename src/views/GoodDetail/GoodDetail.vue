          ...
          <div class="detail_head">
            <div class="img_swiper">
              <div class="swiper_main">
                <img
                  :data-src="data.cover_url"
                  v-lazyload="'/Status/default.svg'"
                />
            ...
            <div class="detail_info">
              ...
              <div class="detail_btns">
                <button
                  class="buy"
                  @click="handleValidate(handleToOrderConfirm)"
                >
                  立即购买
                </button>
                <button class="add" @click="handleValidate(handleAddToCart)">
                  加入购物车
                </button>
              </div>
            </div>
...
const status: string[] = [
  '',
  '/Status/b62a22805ff37997c816cb91984d71be_1387051523058128219.png',
  '',
  '/Status/52a332d5a64c66bd3471f5ed39c35868_7340073586395887667.png'
]
